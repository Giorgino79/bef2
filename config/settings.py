...
Azienda: giiSoftware Spa
Email progetto: danigioloso@gmail.com
"""
...
# Apps Locali BEF-PRO - Struttura reale del progetto
LOCAL_APPS = [
    'core',          # App core nella root del progetto (NON apps.core)
    # 'accounts',      # Gestione utenti e profili (da creare)
    # 'prodotti',      # Anagrafica prodotti e categorie (da creare)
    # 'mag2',          # Sistema magazzino V2 (da creare)
    # 'acquisti',      # Gestione ordini e acquisti (da creare)
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Context processors personalizzati (PERCORSO CORRETTO per struttura reale)
...
# ==============================================================================
# COMPANY INFORMATION - giiSoftware Spa
# ==============================================================================
...
LOGGING = {
    ...
    'loggers': {
        ...
        'apps': {  # Nostri moduli (PERCORSO CORRETTO)
...
if DEBUG:
    ...
    DEBUG_TOOLBAR_PANELS = [
        ...
        'debug_toolbar.panels.settings.SettatesPanel',
